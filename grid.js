...
var setupHandlers = function(useSizeUpDefaults) {
  var modKeys1 = ['cmd', 'alt'],
    modKeys2 = ['cmd'],
    screenKeys = ['ctrl', 'alt'];

  var quarters = [
    new Key('keypad7', modKeys2, putWindow('topLeft')),
    new Key('keypad9', modKeys2, putWindow('topRight')),
    new Key('keypad1', modKeys2, putWindow('bottomLeft')),
    new Key('keypad3', modKeys2, putWindow('bottomRight')),
  ];

  return {
    up: new Key('keypad8', modKeys2, putWindow('up')),
    down: new Key('keypad2', modKeys2, putWindow('down')),
    left: new Key('keypad4', modKeys2, putWindow('left')),
    right: new Key('keypad6', modKeys2, putWindow('right')),
    ...
    moveTo1: new Key('keypad1', screenKeys, moveWindowToScreen(2)),
    moveTo2: new Key('keypad2', screenKeys, moveWindowToScreen(0)),
    moveTo3: new Key('keypad3', screenKeys, moveWindowToScreen(1)),
  };
};
...
var getSubFrame = function(parentFrame, direction) {
  ...
  var subFrames = {
    ...
    centre: {
      x: x(parentHalfWide / 2),
      y: y(parentHalfHigh / 2),
      width: parentHalfWide,
      height: parentHalfHigh,
    },
    leftThird: {
...
var moveWindowToScreen = function(screenNumber) {
  return function() {
    ...
    var newScreenFrame = screenList[screenNumber].frame();
...
var putWindowScreen = function(toScreen) {
  return function() {
    ...
    var candidateOtherScreens = _.reject(screenList, function(s) {
      return s.identifier() == currentScreen.identifier();
    });
